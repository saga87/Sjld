...
<script type="text/javascript" src="system/js/login/logindev.js"></script>
...
<body>
      ...
      <form method="POST">
          ...
          <div class="name mm"><div class="yhm">密&nbsp;&nbsp;码：</div><input name="password" type="password" value="" /></div>
           <div class="name mm yzm"><div class="yhm">验证码：</div><input id="zxh_yzm" name="yzm" type="text" value="" class="name_t yzm_t"/><img class="chao_yzm" src="validateCodeServlet" width="45" height="24" onclick="reloadImg(this);" title="点击更换一张验证码图片"/></div>
