...
$(function(){
    ...
    lay=$("#beicuiEvent_layout").ligerLayout({rightWidth:560,isRightCollapse: true});
    
    manager = $("#beicuiEvent_maingrid").ligerGrid({
        url:'eventWf/WkrjEventWf/getYicuibanEventWfList',
        columns: [
...
//        }
        ...
        onDblClickRow: function (data, rowindex, rowobj) {
        	var s = parent.$.ligerDialog.open({
                ...
                url : "page/sjc/beicuiEvent/beicuiDetails.jsp",
