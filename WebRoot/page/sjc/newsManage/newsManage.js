...
$(function(){
	...
	manager = $("#newsManage_maingrid").ligerGrid({
        ...
        //{ display: '新闻内容', name: 'news_content', id: 'news_content', width: '20%', align: 'center' },
        //{ display: '新闻类型', name: 'news_type', id: 'news_type', width: '10%', align: 'center', render:transferType },
		...
		toolbar : {
			items : [ {
				...
				text : '签收',
				click : newsManage_sign,
				icon : 'modify',
				id:'wkrjsystem/newsManage/signNews'
			}, {
				text : '查看新闻内容',
				click : newsManage_check,
				icon : 'search',
				id:'wkrjsystem/newsManage/checkNews'
			}/* , {
				text : '查看附件列表',
				click : checkFileList,
				icon : 'search',
				...
				click : checkOpList,
				icon : 'search',
				id:'wkrjsystem/newsManage/checkOpList'
			}]
		}
    });
