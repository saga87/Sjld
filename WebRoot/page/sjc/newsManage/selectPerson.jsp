...
$(function(){
	...
	//$("#str_ids").val(data.str_id);
	$.each(data.str_id.split(";"),function(i,v){
		checkedUser_id.push(v);
	});
	//$("#str_names").val(data.str_name);
	$.each(data.str_name.split(";"),function(i,v){
		checkedUser_realname.push(v);
	});
