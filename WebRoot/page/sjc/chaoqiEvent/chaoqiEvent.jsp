...
<%@include file="/systemdev/myContext.jsp" %>
 <head>
<script type="text/javascript" src="page/sjc/chaoqiEvent/chaoqiEvent.js"></script>
...
<div id="overtimeEvent_layout" style="width:100%;">    
    <div position="center">
        <div id="overtimeEvent_maingrid"></div>
    </div>
</div>
</body>
</html>
