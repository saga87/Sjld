...
<%@include file="/systemdev/myContext.jsp" %>
 <head>
<script type="text/javascript" src="page/sjc/dealingEvent/dealingEvent.js"></script>
...
<div id="notDealEventWf_layout" style="width:100%;">    
    <div position="center">
        ...
        <div id="notDealEventWf_maingrid"></div>
    </div>
</div>
</body>
</html>
