...
$(function(){
    ...
    lay=$("#jjdqEvent_layout").ligerLayout({rightWidth:560,isRightCollapse: true});
    
    manager = $("#jjdqEvent_maingrid").ligerGrid({
        url:'eventWf/WkrjEventWf/getJjdqEventWfList',
        columns: [
...
//        }
        ...
        onDblClickRow: function (data, rowindex, rowobj) {
        	var s = parent.$.ligerDialog.open({
                ...
                url : "page/sjc/jjdqEvent/jjdqDetails.jsp",
