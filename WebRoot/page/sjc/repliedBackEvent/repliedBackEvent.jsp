...
<%@include file="/systemdev/myContext.jsp" %>
 <head>
<script type="text/javascript" src="page/sjc/repliedBackEvent/repliedBackEvent.js"></script>
...
<div id="repliedBackedEventWf_layout" style="width:100%;">    
    <div position="center">
        <div id="repliedBackedEventWf_maingrid"></div>
    </div>
</div>
</body>
</html>
