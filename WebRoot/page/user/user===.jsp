...
<div style="width:100%;height:100%;">
	<div class="easyui-layout" data-options="fit:true">
		...
		<div id="usermanagetoolbar">
			...
			部门：<input class="easyui-combotree" name="parent_department_id"
					data-options="method:'get',panelWidth:'300',panelHeight:'300'" id="searchUserDept" url="wkrjsystem/wkrjDept/getDeptTree"/>
			用户名：<input class="easyui-validatebox" id="searchUserRealname" />
			<a  href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true"
				ekper="wkrjsystem/wkrjUser/getUserList" onclick="searchUser()">查询</a>
			<a  href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true"
				ekper="wkrjsystem/wkrjUser/getUserList" onclick="showAllUser()">全部显示</a>
		</div>
